...
Нужно доделать роутер и запуск в мейне, настроить докер, протестировать ручками что все работает, а вероятно оно не заработает с первого раза, покрыть тестами, написать интегряшки, но к сожалению я не успеваю к дате сдачи, но все равно выложу на гит
